...
使用第3方网站解析了一些视频网站的源地址，直接可以用内置播放器播放，不用跳转到网页播放视频（在64位系统上不能使用）。</br>
...
####用户信息
<img src="./img/user.png" width = "225" height = "400"  />
####微博信息
<img src="./img/item.png" width = "225" height = "400"  />
####评论
<img src="./img/comment.png" width = "225" height = "400"  />
####关注用户（灰色方块为未做好的关注或取消关注按钮）
<img src="./img/like.png" width = "225" height = "400"  />
####使用'正在烘焙'和'正在配置调料'代替'正在加载'
<img src="./img/load_1.png" width = "225" height = "400"  />
<img src="./img/load_2.png" width = "225" height = "400"  />
