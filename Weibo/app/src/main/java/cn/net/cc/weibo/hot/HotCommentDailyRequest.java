 ...
 */
public class HotCommentDailyRequest implements INoIdListAPI{

    private StatusesAPI statusesAPI;

    public HotCommentDailyRequest(Context context) {
        // 获取当前已保存过的 Token
    ...
    public void loadList(long sinceId, long maxId, int count, int type, RequestListener listener) {
        statusesAPI.hotCommentsDaily(20, false, listener);
    }
}
