package cn.net.cc.weibo.post.idea.imagelist;
...
public class ImgListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ImgViewHolder) {
            ImageLoader.with(mContext, "file:///" + mDatas.get(position).getImageFile().getAbsolutePath(), ((ImgViewHolder) holder).imageView);
