 ...
 * Use the {@link AiteWeiboFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AiteWeiboFragment extends BaseListFragment<Status> {
    ...
    private ILoadListModel aiteWeiboModel;

    public AiteWeiboFragment() {
     ...
     */
    public static AiteWeiboFragment newInstance(String param1, String param2) {
        AiteWeiboFragment fragment = new AiteWeiboFragment();
    ...
    @Override
    protected void init() {
        aiteWeiboModel = new NoIdWeiboModel(getContext(),this, new AiteWeiboRequest(getContext()));
